...
import { microTask, idlePeriod, timeOut } from '../@polymer/polymer/lib/utils/async.js';
...
const $_documentContainer$4 = html`<dom-module id="lumo-tab" theme-for="vaadin-tab">
  <template>
    <style>
      :host {
...
const $_documentContainer$7 = html`<dom-module id="lumo-tabs" theme-for="vaadin-tabs">
  <template>
    <style>
      :host {
